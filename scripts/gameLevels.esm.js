...
export const GAME_BOARD_X_OFFSET = 60;
export const GAME_BOARD_Y_OFFSET = 14;
...
export const gameLevels = [
    {
        ...
        board: [
            ...
            { x: 2 * DIAMOND_SIZE, y: 0 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 2, column: 1, kind: 1 },
            ...
            { x: 3 * DIAMOND_SIZE, y: 1 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 3, column: 2, kind: 4 },
            ...
            { x: 5 * DIAMOND_SIZE, y: 3 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 5, column: 4, kind: 0 },
            { x: 0 * DIAMOND_SIZE, y: 4 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 0, column: 5, kind: 2 },
            { x: 1 * DIAMOND_SIZE, y: 4 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 1, column: 5, kind: 4 },
            { x: 2 * DIAMOND_SIZE, y: 4 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 2, column: 5, kind: 2 },
            { x: 3 * DIAMOND_SIZE, y: 4 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 3, column: 5, kind: 3 },
            ...
            { x: 1 * DIAMOND_SIZE, y: 6 * DIAMOND_SIZE + GAME_BOARD_Y_OFFSET, row: 1, column: 7, kind: 0 },
